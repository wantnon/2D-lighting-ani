...
public:
    ...
    void setUseLightingEffect(bool value){useLightingEffect=value;}
    bool getUseLightingEffect()const {return useLightingEffect;}
    void setHScale(float value){hScale=value;}
    float getHScale()const {return hScale;}
    map<CCTexture2D*,CCTexture2D*> heightTexMap;
private:
