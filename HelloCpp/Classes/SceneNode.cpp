...
bool SceneNode::init(string colorTexFileName,string heightMapTexFileName)
{
    ...
    //renderRipple shader
	{
        ...
        myUnifoMap["hScale"] = glGetUniformLocation(pProgram->getProgram(),"hScale");
...
void SceneNode::draw()
{
    if(useLightingEffect){
        //change texHeight
        this->texHeightMap=this->heightTexMap[this->getTexture()];
        //change shader
        ...
        glUniform1f(program_renderRipple.myUnifoMap["hScale"],hScale);
